...
Teste de Argumentos Opcionais
    Passando argumentos opcionais como parâmetro      nome=William   ultimo_nome=Soares
    Passando argumentos opcionais como parâmetro      nome=William   nome_do_meio=Gomes     ultimo_nome=Soares
...
Criando lista e dicionário via parâmetro
    ...
    Teste Criando uma Lista         William   Gomes   Soares
    Teste Criando os dois           William   Gomes   Soares    shell=True    env=False
...
Passando argumentos opcionais como parâmetro
    ...
    [Arguments]     ${nome}   ${ultimo_nome}   ${nome_do_meio}=Gomes
